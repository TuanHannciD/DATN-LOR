    ...
    public class SanPhamChiTietConfiguration : IEntityTypeConfiguration<SanPhamChiTiet>
    {
        public void Configure(EntityTypeBuilder<SanPhamChiTiet> builder)
        {
            ...
            builder.HasData(
                new SanPhamChiTiet
                {
                    ID_Spct = Guid.NewGuid(),
                    ID_Sp = new Guid("a0e6c70b-6c4a-4b9e-9d2a-0a4a8b0e7a2b"), // Sử dụng ID_Sp từ SanPham đã seed
                    ...
                    DanhGia = "Tốt",
                    ID_ChatLieu = new Guid("1a2b3c4d-5e6f-7a8b-9c0d-1e2f3a4b5c6d"), // ID ChatLieu: Cotton
                    ID_Hang = new Guid("a1b2c3d4-e5f6-7a8b-9c0d-1e2f3a4b5c6e"), // ID HangSX: Nike
                    ID_MauSac = new Guid("11223344-5566-7788-99aa-bbccddeeff11"), // ID MauSac: Đỏ
                    ID_Size = new Guid("ffeeddcc-bbaa-9988-7766-554433221100") // ID Size: S
                },
                new SanPhamChiTiet
                {
                    ID_Spct = Guid.NewGuid(),
                    ID_Sp = new Guid("b1c7d81c-7d81-4e9c-8e0a-0a4a8b0e7a2b"), // Sử dụng ID_Sp từ SanPham đã seed
                    ...
                    DanhGia = "Tuyệt vời",
                    ID_ChatLieu = new Guid("8a9b0c1d-2e3f-4a5b-6c7d-8e9f0a1b2c3d"), // ID ChatLieu: Len
                    ID_Hang = new Guid("f1e2d3c4-b5a6-9d8e-7c6b-5a4d3c2b1a0e"), // ID HangSX: Adidas
                    ID_MauSac = new Guid("22334455-6677-8899-aabb-ccddeeff22"), // ID MauSac: Xanh
                    ID_Size = new Guid("eeddccbb-aa99-8877-6655-443322110000") // ID Size: M
                }
            );
        }
    }
